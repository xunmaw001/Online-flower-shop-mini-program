...
public class XianhuaCommentbackView extends XianhuaCommentbackEntity implements Serializable {
	...
	public XianhuaCommentbackView() {

	}

	public XianhuaCommentbackView(XianhuaCommentbackEntity xianhuaCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, xianhuaCommentbackEntity);
