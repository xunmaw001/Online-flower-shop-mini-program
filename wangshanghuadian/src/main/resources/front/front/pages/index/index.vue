        ...
        <view class="listBox recommend">
                ...
                <view class="title"
                    ...
                    <text
                            ...
                            @tap="onPageTap('xianhua')">查看更多
                    </text>
                </view>
<view class="list-box style8"
    ...
    <view v-if="xianhuaList.length > 0" @tap="onDetailTap('xianhua',xianhuaList[0].id)"
          class="box box1"
          :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"160rpx"}'>
        <div v-if="true"
             ...
             class="title hide1">{{xianhuaList[0].xianhuaName}}</div>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+xianhuaList[0].xianhuaPhoto">
        </image>
    </view>
    <view class="list-item">
        <view v-if="xianhuaList.length > 1" @tap="onDetailTap('xianhua',xianhuaList[1].id)"
              class="box box2"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 2% 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"32%","borderStyle":"solid","height":"160rpx"}'>
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{xianhuaList[1].xianhuaName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+xianhuaList[1].xianhuaPhoto">
            </image>
        </view>
        <view v-if="xianhuaList.length > 2" @tap="onDetailTap('xianhua',xianhuaList[2].id)"
              class="box box3"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 2% 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"32%","borderStyle":"solid","height":"160rpx"}'>
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{xianhuaList[2].xianhuaName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+xianhuaList[2].xianhuaPhoto">
            </image>
        </view>
        <view v-if="xianhuaList.length > 3" @tap="onDetailTap('xianhua',xianhuaList[3].id)"
              class="box box4"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"32%","borderStyle":"solid","height":"160rpx"}'>
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{xianhuaList[3].xianhuaName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+xianhuaList[3].xianhuaPhoto">
            </image>
        </view>
    </view>
    <view class="list-item">
        <view v-if="xianhuaList.length > 4" @tap="onDetailTap('xianhua',xianhuaList[4].id)"
              class="box box5"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 2% 0 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"49%","borderStyle":"solid","height":"160rpx"}'>
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{xianhuaList[4].xianhuaName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+xianhuaList[4].xianhuaPhoto">
            </image>
        </view>
        <view v-if="xianhuaList.length > 5" @tap="onDetailTap('xianhua',xianhuaList[5].id)"
              class="box box6"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"49%","borderStyle":"solid","height":"160rpx"}'>
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{xianhuaList[5].xianhuaName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+xianhuaList[5].xianhuaPhoto">
            </image>
        </view>
    </view>
</view>
    ...
    <view @tap="onDetailTap('gonggao',item.id)" v-for="(item,index) in gonggaoList" :key="index" class="list-item"
          :style='{"padding":"20rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"16rpx 3%","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,255,255,1)","borderRadius":"200rpx 200rpx 20rpx 200rpx","borderWidth":"8rpx","width":"94%","borderStyle":"solid","height":"auto"}'
