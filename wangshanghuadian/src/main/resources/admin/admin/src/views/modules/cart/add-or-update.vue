            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='xianhua' ">
                    <el-form-item class="input" v-if="type!='info'"  label="鲜花编号" prop="xianhuaUuidNumber">
                        <el-input v-model="xianhuaForm.xianhuaUuidNumber"
                                  placeholder="鲜花编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='xianhua' ">
                    <el-form-item class="input" v-if="type!='info'"  label="花语" prop="xianhuaHuayu">
                        <el-input v-model="xianhuaForm.xianhuaHuayu"
                                  placeholder="花语" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='xianhua' ">
                    <el-form-item class="input" v-if="type!='info'"  label="赞" prop="zanNumber">
                        <el-input v-model="xianhuaForm.zanNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='xianhua' ">
                    <el-form-item class="input" v-if="type!='info'"  label="踩" prop="caiNumber">
                        <el-input v-model="xianhuaForm.caiNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='xianhua' ">
                    <el-form-item class="input" v-if="type!='info'"  label="鲜花数量" prop="xianhuaKucunNumber">
                        <el-input v-model="xianhuaForm.xianhuaKucunNumber"
                                  placeholder="鲜花数量" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='xianhua' ">
                    <el-form-item class="input" v-if="type!='info'"  label="鲜花原价" prop="xianhuaOldMoney">
                        <el-input v-model="xianhuaForm.xianhuaOldMoney"
                                  placeholder="鲜花原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='xianhua' ">
                    <el-form-item class="input" v-if="type!='info'"  label="鲜花热度" prop="xianhuaClicknum">
                        <el-input v-model="xianhuaForm.xianhuaClicknum"
                                  placeholder="鲜花热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="鲜花热度" prop="xianhuaClicknum">
                            <el-input v-model="ruleForm.xianhuaClicknum"
                                      placeholder="鲜花热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
